...
/** Triggers Supabase OAuth flow for Google or GitHub */
  ...
  return (
    <div className="flex flex-col gap-4">
      <button
        ...
        className="flex w-full items-center justify-center gap-3 py-3.5 px-4 rounded-xl border border-zs-border bg-zs-bg-secondary text-zs-text-primary transition-all duration-300 hover:border-zs-blue/50 hover:bg-zs-blue/5 hover:shadow-zs-glow-blue/20 group"
      >
        <svg
          width="20"
          height="20"
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-3 py-3.5 px-4 rounded-xl border border-zs-border bg-zs-bg-secondary text-zs-text-primary transition-all duration-300 hover:border-zs-emerald/50 hover:bg-zs-emerald/5 hover:shadow-zs-glow-emerald/20 group"
      >
        <svg
          width="20"
          height="20"
