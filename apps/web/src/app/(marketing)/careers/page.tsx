        ...
        <main className="pt-32 pb-24 bg-zs-bg-primary min-h-screen relative overflow-hidden">
            ...
            <div className="container px-4 mx-auto relative z-10">
                ...
                >
                    ...
                    <h1 className="text-2xl md:text-5xl font-black text-white tracking-tighter uppercase italic leading-none mb-12">
                ...
                <section className="relative p-16 rounded-[4rem] bg-zs-blue relative overflow-hidden group">
                    ...
                    <div className="max-w-3xl relative z-10">
                        <h2 className="text-2xl md:text-5xl font-black text-white uppercase italic tracking-tighter mb-8 leading-none">¿No ves tu <span className="text-black/40">Rol Ideal?</span></h2>
